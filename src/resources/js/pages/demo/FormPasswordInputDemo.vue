...
import BasePasswordInput from "@/core/forms/components/baseInputs/BasePasswordInput.vue";
...
const referenceProperties = [
    ...
    },
    {
        ...
        default: "",
        required: false,
        description: "Autocomplete attribute on the input",
    },
    {
        property: "disabled",
        type: "boolean",
    ...
    },
    {
        ...
        default: "false",
        required: false,
        description: "When true, user will not be able to show the password",
    },
    {
        property: "label",
        type: "string",
...
<template>
    <div class="flex flex-col gap-2">
        <Card title="Description">
            <h3 class="text-center mb-3">Password Input</h3>
            <p class="text-center">Password input with unmask ability.</p>
        </Card>
        <ExampleComponent show>
            ...
            <template #code>
                &lt;script setup&gt; <br />
                &emsp;import BasePasswordInput from
                "@/core/forms/components/baseInputs/BasePasswordInput.vue";
                <br />
                &lt;/script&gt;<br />
                <br />
                &lt;template&gt;<br />
